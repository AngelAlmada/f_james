...
export function SeccionH() {
    ...
    return (
        <div className="flex flex-col gap-10">
            ...
            <SectionComponent
                title={
                    <h2 className="relative after:block after:mt-2 after:h-1 after:w-16 after:bg-stone-700 after:mx-auto after:rounded-full 
            ...
            <SectionComponent
                ...
                media={{ type: "video", src: "/videos/vid7.mp4" }}
                imagePosition="right"
                hasOverlay={false}
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="flex flex-col sm:flex-row gap-10">
                            ...
                            <div className="flex flex-col items-center gap-3 p-5 w-full sm:w-1/2">
                                <img src={t("images/vision.png")} alt="Icono Visión" className="w-16 h-16 object-contain" />
                                <h3 className="text-xl font-bold text-center">{t("home.vision_title")}</h3>
                                <p className="text-gray-600 text-center">{t("home.vision_content")}</p>
                            </div>

                            {/* 🔹 Misión */}
                            <div className="flex flex-col gap-3 p-5 w-full sm:w-1/2 items-center">
                                <img src={t("images/mission.png")} alt="Icono Misión" className="w-16 h-16 object-contain" />
                                <h3 className="text-xl font-bold text-center">{t("home.mission_title")}</h3>
                                <p className="text-gray-600 text-center">{t("home.mission_content")}</p>
                            </div>
                        </div>
                    </div>
                }
        ...
        text-center text-4xl font-trajanus text-stone-700 custom-title">
            ...
            <SectionComponent
                title={
                    <h2 className="relative after:block after:mt-2 after:h-1 after:w-16 after:bg-stone-700 after:mx-auto after:rounded-full 
        text-center text-4xl font-trajanus text-stone-700 custom-title">
                        {t("home.noticias_title2")}
                    </h2>
                }
                content={
                    <div className="w-full flex flex-col items-start text-left">
                        <p>{t("home.noticias_content2")}</p>
                    </div>
                }
                media={{ type: "image", src: "/images/Cattle_s5.png" }}
                imagePosition="left"
                hasOverlay={true}
                animation={slideInFromBottom}
            />
